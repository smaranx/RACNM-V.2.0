...
<head>
  ...
  <!--link href="assets/img/roundLog0.png" rel="logo-touch-icon"-->
  ...
  <!-- =======================================================
  * Name: RACNM - v2.0
  * Template URL: https://racnavimumbai.org
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="icon-box"><br>
              ...
              <h3><a href="">Environment Protection</a></h3>
              <p>With the daily rising tempterture and global warming, we actively take steps towards sustainability, awareness and partnering with organisations that work for the protection of Environment.</p>
            </div>
          </div>
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="icon-box"><br>
              ...
              <p>Education is an important asset of thre modern world. We constantly strive to provide learning oppoertunities and improving the quality of education for the upcoming generation.</p>
            </div>
          </div>
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="icon-box"><br>
              <i class="fas fa-brain"></i><br>
              <h3><a href="">Mental Health Awareness</a></h3>
              <p>We intend on breaking the stigma, continuing our work on denying the stereotypes associated with disorders and treatments. We focus to make the world safe to talk, to seek help and empathise. </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <p>Serving society and making this place a better place to live.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p>Contributing to the Personal, Professional and Mnetal Development of the community.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Entreprenuership Development</a></h4>
              <p>Nurturing, Scaling and complete guidance to start-up or business.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">International Services</a></h4>
              <p>International exposure through collabration of clubs around the world.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <p>Exposure and expereince of playing and participating in various indoor and outdoor games.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="">Digital Communications</a></h4>
              <p>Graphic designing, Video editing and Editorials in support of another avenues.</p>
            </div>
          </div>
